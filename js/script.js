...
It is called with an object containing the following properties:
  ...
  lineOffset : vertical position of 1st line of mensetAttributeu
...
Puzzle.prototype.removeAllListeners = function() {
  let forPuzzle = document.getElementById('forPuzzle')
...
console.log('removeAllListeners');
  ...
  forPuzzle.classList.add('flip-box-back');
  setTimeout(x=>{
    forPuzzle.classList.add('display-none');
...
let errorPage = document.getElementById('error-page');
  ...
  if (this.anim.cpt == 0){
    console.log(this.anim.cpt, 'thissssssss');
    console.log(this.anim.tmr); // output 3
    
    window.clearInterval(this.anim.tmr); 
    console.log(this.anim , 'thisanim');
  ...
  console.log(xcou,'xcou');
  ycou = parseFloat(this.canvMobile.style.top);
  console.log(ycou,'ycou');
  ...
  console.log(this.canvMobile.style.left ,'canvMobilestyleleft',this.canvMobile.style.top,'canvMobile' )
...
Puzzle.prototype.beginGame = function() {
  ...
  let imageCenter = document.getElementById('Image-Center');

imageCenter.classList.remove('display-none')
...
let img = '../images/pixel6-logo.svg';
